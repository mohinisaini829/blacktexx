...
export default class NetzpPowerpack6Imagecompare extends window.PluginBaseClass
{
    static options = {
        el: '',
        controlColor: '#FFFFFF',
    ...
    init() {
        ...
        if(this.options.labelBefore != '' && this.options.labelAfter != '') {
            this.settings.labelOptions = {
                onHover: true,
                before: this.options.labelBefore,
                after: this.options.labelAfter,
            };
