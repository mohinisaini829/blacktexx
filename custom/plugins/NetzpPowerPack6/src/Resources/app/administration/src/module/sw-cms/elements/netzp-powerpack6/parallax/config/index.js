...
import template from './sw-cms-el-config-netzp-powerpack6-parallax.html.twig';
import './sw-cms-el-config-netzp-powerpack6-parallax.scss';

Component.register('sw-cms-el-config-netzp-powerpack6-parallax', {
    template,
