...
import template from './sw-cms-el-config-netzp-powerpack6-imagecompare.html.twig';
import './sw-cms-el-config-netzp-powerpack6-imagecompare.scss';

Component.register('sw-cms-el-config-netzp-powerpack6-imagecompare', {
    template,
