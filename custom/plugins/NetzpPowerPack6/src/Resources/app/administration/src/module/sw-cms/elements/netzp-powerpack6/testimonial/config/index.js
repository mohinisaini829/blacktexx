...
import template from './sw-cms-el-config-netzp-powerpack6-testimonial.html.twig';
import './sw-cms-el-config-netzp-powerpack6-testimonial.scss';

Component.register('sw-cms-el-config-netzp-powerpack6-testimonial', {
    template,
