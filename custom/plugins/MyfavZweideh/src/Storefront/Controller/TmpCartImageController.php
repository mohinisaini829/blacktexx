...
class TmpCartImageController extends StorefrontController {
    private $connection;
    ...
    #[Route(
        path: '/myfavDesigner/tmp/cart/image',
        name: 'frontend.myfav.zweideh.tmp.cart.image',
        methods: ['GET'],
        defaults: ['XmlHttpRequest' => true]
    )]
    public function getTmpCartImage(Request $request, SalesChannelContext $salesChannelContext): Response
    {
        //die('4444444');
        ...
        // Load lumis Data.
        $tmpCart = $this->shopwareDesignsService->load($key, $tmp_cart_id);
