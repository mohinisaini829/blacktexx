...
class BlogSearchController extends StorefrontController
{
    ...
    #[Route('/sas_blog_search', name: 'frontend.sas.blog.search', methods: ['GET'])]
     ...
     */
    #[Route('/widgets/blog-search', name: 'widgets.blog.search.pagelet', defaults: ['XmlHttpRequest' => true], methods: ['GET', 'POST'])]
