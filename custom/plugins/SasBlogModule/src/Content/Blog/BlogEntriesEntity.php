...
class BlogEntriesEntity extends Entity
{
    ...
    protected ?BlogCategoryEntity $seoCategory = null;
    ...
    protected ?ProductCollection $assignedProducts = null;
    ...
    protected ?SasTagCollection $tags = null;

    public function getTags(): ?SasTagCollection
    {
        return $this->tags;
    }

    public function setTags(?SasTagCollection $tags): void
    {
        $this->tags = $tags;
    }

    public function getAssignedProducts(): ?ProductCollection
    {
        return $this->assignedProducts;
    }

    public function setAssignedProducts(?ProductCollection $assignedProducts): void
    {
    ...
    public function getSeoCategory(): ?BlogCategoryEntity
    {
        return $this->seoCategory;
    }

    public function setSeoCategory(?BlogCategoryEntity $category): void
    {
