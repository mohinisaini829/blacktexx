...
Shopware.Component.register('sw-cms-el-blog-single-select', {
    ...
    data() {
        return {
            ...
            teaser:
                'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque faucibus maximus velit, ' +
                'dictum mollis erat finibus quis. Ut dictum ornare dolor, sed mattis tellus gravida vel.',
            mediaUrl: null,
    ...
    computed: {
        articleImage() {
            return this.mediaUrl
                ? this.mediaUrl
                : `${Shopware.Context.api.assetsPath}/administration/static/img/cms/preview_mountain_small.jpg`;
        },
    ...
    methods: {
        ...
        getEntityProperties() {
            if (this.element.config.blogEntry.value) {
                ...
                this.repository
                    .get(
                        this.element.config.blogEntry.value,
                        Context.api,
                        criteria,
                    )
                    .then((entity) => {
                        ...
                        this.categoryName = this.article.blogCategories[0]
                            ? this.article.blogCategories[0].translated.name
                            : null;
                    });
            } else {
                this.article = null;
