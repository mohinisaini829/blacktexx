 ...
 */
#[Package('content')]
class MyfavNewsletterCaptcha extends StorefrontController
{
  ...
  /**
   * @Since("6.1.0.0")
   * @Route("/form/newsletter", name="frontend.form.newsletter.register.handle", methods={"POST"}, defaults={"XmlHttpRequest"=true, "_captcha"=false})
   */
